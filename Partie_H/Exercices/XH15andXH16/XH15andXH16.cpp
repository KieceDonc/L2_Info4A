...
class Polygone{
  ...
  public:
    ...
    static Polygone* creeTriangle(Point* p1, Point* p2, Point* p3);
...
Polygone* Polygone::creeTriangle(Point* p1, Point* p2, Point* p3){
...
int main(){
  ...
  Point pt2 = {3,3};
  Point pt3 = {1.5,1.5};
  Polygone* p1 = Polygone::creeTriangle(&pt1,&pt2,&pt3);
  Polygone p2 = *p1;
  p1->affiche();
  p2.affiche();
